<?php namespace System\Libraries\Tbs; //echo APPPATH;

use System\Helpers\FileLoad\Loader;
//require_once('vendor/tinybutstrong/tinybutstrong/tbs_class.php');
...
class GeeglerTbs extends \clsTinyButStrong
{
    ...
    public function __construct()
    {
        ...
        $this->chr_open = str_replace('|',' ',$this->config['ldel']);
        $this->chr_close = str_replace('|',' ',$this->config['rdel']);
        //echo $config['ldel'].'<br/>';
        $this->SetOption(array('chr_open' => $this->chr_open, 'chr_close' => $this->chr_close ));
        $this->extension = $this->config['tpl_extension'];
		//echo $this->extension;
    }


    public function view($data = array(), $template, $data2 = null,$data3 = null, $data4 = null,$data5= null,$data6=null,$data7=null,$data8=null,$data9=null,$data10=null,$data11=null  )
    {
		//echo TPL_DEFAULT;
